...
angular.module('esCalendar', ['esDay']);
'use strict';

angular.module('esManageEvent', ['ui.bootstrap.datetimepicker', 'ngRoute']);
'use strict';

angular.module('esCore', ['esCore.event', 'esCore.storage', 'esCore.template']);
'use strict';
...
'use strict';
angular.module('esCore.template', []);
'use strict';
...
angular.module('esCore.template').run(['$templateCache', function($templateCache) {$templateCache.put('src/modules/es-day/es-day.template.html','<div class="m-b-0">\r\n  <!-- <div class="panel-heading"> -->\r\n  <div class="es-day-header">\r\n    <span class="es-day-number" ng-bind="$ctrl.currentDay | amDateFormat: \'DD\' "></span>\r\n    <span class="es-day-name" ng-bind="$ctrl.currentDay | amDateFormat: \'dddd\' "></span>\r\n  </div>\r\n  <!-- </div> -->\r\n  <div class="es-day-body p-0">\r\n    <div class="ng-hide" ng-show="!$ctrl.events.length">\r\n      <p class="text-center p-10 m-b-0 es-no-events"><i class="fa fa-calendar-o" aria-hidden="true"></i>\r\n        <br>There are no events</p>\r\n    </div>\r\n\r\n    <div ng-repeat="event in $ctrl.events track by $index" class="es-event-list">\r\n      <div class="es-event-remove text-right" ng-click="$ctrl.removeEvent(event.uid, $index)"><i class="fa fa-times"></i></div>\r\n\r\n      <div class="es-event-wrapper p-10" ng-click="$ctrl.viewDetails(event.uid)">\r\n      \r\n\r\n        <span ng-bind="event.name" class="es-event-name"></span>\r\n      \r\n        <div class="es-event-time">\r\n          <i class="fa fa-clock-o" aria-hidden="true"></i> <span ng-bind="event.start | amDateFormat: \'h:mm a\' "></span> -\r\n      \r\n          <span ng-if="!event.isAllDay">\r\n            <span ng-bind="event.end | amDateFormat: \'h:mm a\' "></span>\r\n          </span>\r\n      \r\n          <span ng-if="event.isAllDay">All day</span>\r\n        </div>\r\n      \r\n      </div>\r\n    </div>\r\n\r\n  </div>\r\n</div>\r\n');
$templateCache.put('src/modules/es-day/es-event-popover.template.html','\r\n{{$ctrl.event}}\r\n\r\n<button class="btn btn-primary">Update</button>');
$templateCache.put('src/modules/es-calendar/es-calendar-notify.template.html','<div class="ui-notification custom-template">\r\n  <h3> <i class="fa fa-calendar-o" aria-hidden="true"></i> <span ng-bind="title"></span> </h3>\r\n  <div class="message" ng-bind-html="message"></div>\r\n  <div class="message">\r\n    \r\n      <div ng-repeat="event in upcomingEvents" class="upcoming-event-item">\r\n        <h5>{{event.name}}</h5>\r\n        <p><span ng-bind="event.start | amDateFormat: \'dddd, MMMM Do YYYY, h:mm a\'"></span></p>\r\n      </div>\r\n    \r\n  </div>\r\n  \r\n</div>\r\n');
$templateCache.put('src/modules/es-calendar/es-calendar.template.html','<div class="cal-container m-t-20">\r\n  <div class="es-calendar-header clearfix">\r\n\r\n    <h2 class="es-calendar-month"><span ng-bind="$ctrl.today | amDateFormat: \'MMMM YYYY\' "></span></h2>\r\n\r\n    <div class="es-calendar-controls m-b-15">\r\n      <div class="btn-group">\r\n        \r\n        <button ng-click="$ctrl.goToWeek(-1)" class="btn btn-default btn"><i class="fa fa-chevron-left"></i></button>\r\n        <button ng-click="$ctrl.goToWeek(1)" class="btn btn-default"><i class="fa fa-chevron-right"></i></button>\r\n        <a ng-href="#!/event" class="btn btn-primary"><i class="fa fa-plus"></i></a>\r\n      </div>\r\n    </div>\r\n    \r\n  </div>\r\n  <div class="es-week-container">\r\n    <es-day today=\'$ctrl.today\' day-of-week="$index" week-of-year="$ctrl.currentWeek" ng-repeat="i in [0,1,2,3,4,5,6] track by $index" class="es-day-container"></es-day>\r\n  </div>\r\n</div>\r\n');
$templateCache.put('src/modules/es-manage-event/es-manage-event.template.html','\r\n<div class="m-t-20">\r\n\r\n<h2 class="es-calendar-month"><span ng-bind="$ctrl.action.title"></span></h2>\r\n\r\n<form name="eventForm" novalidate>\r\n    <div class="form-group m-t-20">\r\n        <button class="btn btn-default" ng-click="$ctrl.back()"><i class="fa fa-arrow-left" aria-hidden="true"></i></button>\r\n        <button class="btn btn-primary pull-right" ng-disabled="!$ctrl.isValid" ng-click="$ctrl.addEvent()" \r\n        class="ng-hide" ng-show="$ctrl.action.type==\'add\'">Add</button>\r\n        <button class="btn btn-primary pull-right" ng-disabled="!$ctrl.isValid" ng-click="$ctrl.updateEvent()" \r\n        class="ng-hide" ng-show="$ctrl.action.type==\'edit\'">Save</button>\r\n    </div>\r\n\r\n    <div class="form-group">\r\n        <input type="text" ng-model="$ctrl.event.name" class="form-control" placeholder="Untitled event">\r\n    </div>\r\n    <div class="row">\r\n        <div class="col-sm-6">\r\n            <div class="dropdown form-group">\r\n                <a class="dropdown-toggle" id="eventStartDate" data-toggle="dropdown" data-target="#" >\r\n                    <div class="input-group es-datepicker">\r\n                    \t\t<span class="form-control  es-datepicker-label" ng-bind="$ctrl.event.start | amDateFormat: \'ddd, MMM Do YYYY, h:mm a\' "></span>\r\n                        <input type="text" class="form-control es-datepicker-input" data-ng-model="$ctrl.event.start" required name="eventStartDate"  placeholder="Event start at " readonly>\r\n                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>\r\n                    </div>\r\n\t\t\t\t\t\t\t\t\t\r\n                </a>\r\n                <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">\r\n                    <datetimepicker data-ng-model="$ctrl.event.start" data-before-render="$ctrl.beforeTimePick($dates, $view)" data-datetimepicker-config="{ dropdownSelector: \'#eventStartDate\', modelType : \'moment\' }"></datetimepicker>\r\n                </ul>\r\n            </div>\r\n        </div>\r\n        <div class="col-sm-6">\r\n            <div class="dropdown form-group" ng-show="!$ctrl.event.isAllDay" >\r\n                <a class="dropdown-toggle" id="eventEndDate" data-toggle="dropdown" data-target="#" >\r\n                    <div class="input-group es-datepicker">\r\n                    <span class="form-control  es-datepicker-label" ng-bind="$ctrl.event.end | amDateFormat: \'ddd, MMM Do YYYY, h:mm a\' "></span>\r\n                        <input type="text" class="form-control  es-datepicker-input" data-ng-model="$ctrl.event.end" required name="eventEndDate" placeholder="Event finish at" readonly>\r\n                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>\r\n                    </div>\r\n                </a>\r\n                <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">\r\n                    <datetimepicker data-ng-model="$ctrl.event.end"  data-before-render="$ctrl.beforeTimePick($dates, $view)"  data-datetimepicker-config="{ dropdownSelector: \'#eventEndDate\', modelType : \'moment\'}" ></datetimepicker>\r\n                </ul>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div>\r\n        <div class="checkbox">\r\n            <label>\r\n                <input type="checkbox" ng-model="$ctrl.event.isAllDay" /> All day\r\n            </label>\r\n        </div>\r\n\r\n    </div>\r\n    <div>\r\n        <label for="eventDesc">Description</label>\r\n        <textarea ng-model="$ctrl.event.description" class="form-control" rows="3" id="eventDesc"></textarea>\r\n    </div>\r\n</form>\r\n</div>');}]);